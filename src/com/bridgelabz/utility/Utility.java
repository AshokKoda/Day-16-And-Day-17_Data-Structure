...
public class Utility {
	...
	/**
	 * method is check for palindrome number
	 * 
	...
	/**
	 * method for String binary search
	 * 
	 * @param arr input from user
	 * @param key input from user
	 * @return returns index of key searched else returns -1
	...
	/**
	 * method for printing integer array
	 * 
	...
	/**
	 * method for calculating elapsedTime
	 * 
	...
	/**
	 * method for taking information from file
	 * 
	...
	/**
	 * This method will calculate the EMI for the month on the basis of
	...
	/**
	 * adding extra bit into binary number and swap from middle
	 * 
	...
	/**
	 * merge sort method for dividing
	 * 
	 * @param arr   input from user
	...
	/**
	 * method for compare the value and conquer the array
	 * 
	...
	/**
	 * method for insertion sort of String
	 * 
	 * @param arr array from user
	 * @return returns sorted array
	 */
