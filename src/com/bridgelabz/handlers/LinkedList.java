...
public class LinkedList<T> {
	...
	/**
	 * method for insert node at specific index
	 * 
...
//			n = n.next;
	...
	/**
	 * method for delete node at start
	 */
...
//			System.out.println("Node deleted is: " + n1.data);
	...
	/**
	 * method for deleting node at last index
	 */
	...
	/**
	 * printing the list without using spaces
	 */
	...
	/**
	 * method which convert list in string and return it
	 * 
	...
	/**
	 * method for search node from list
	 * 
	...
	/**
	 * method for sort the integer list
	 * 
	...
	/**
	 * method to add all data into linked list
	 * 
